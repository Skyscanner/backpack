...
describe('BpkBannerAlert', () => {
  it('should render correctly with "type" attribute equal to "success"', () => {
    const tree = renderer
      .create(<BpkBannerAlert type={ALERT_TYPES.SUCCESS} message={message} />)
      .toJSON();
  ...
  it('should render correctly with "type" attribute equal to "warn"', () => {
    const tree = renderer
      .create(<BpkBannerAlert type={ALERT_TYPES.WARN} message={message} />)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with "type" attribute equal to "error"', () => {
    const tree = renderer
      .create(<BpkBannerAlert type={ALERT_TYPES.ERROR} message={message} />)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
