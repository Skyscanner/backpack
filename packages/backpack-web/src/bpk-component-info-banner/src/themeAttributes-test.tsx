...
describe('info-banner component themeAttributes', () => {
  it('should export the deprecated themeAttributes default with the legacy keys', () => {
    expect(themeAttributes).toEqual(['infoBannerBackgroundColor']);
  });

  it('should export allInfoBannerThemeAttributes with all unique private info-banner tokens', () => {
    expect(allInfoBannerThemeAttributes).toEqual([
