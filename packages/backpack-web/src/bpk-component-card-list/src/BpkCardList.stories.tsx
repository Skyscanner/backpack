...
import STYLES from './BpkCardList.stories.module.scss';
...
export const Basic = { render: () => <BasicExample /> };
export const RowToRail = { render: () => <RowToRailExample /> };
...
export const VisualTestWithoutTitle = { render: () => <RowToRailWithoutTitleExample /> };
