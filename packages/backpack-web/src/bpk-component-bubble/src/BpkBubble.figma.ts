...
// source=https://github.com/Skyscanner/design-system/blob/main/packages/backpack-web/src/bpk-component-bubble/src/BpkBubble.tsx
// component=BpkBubble
...
export default {
  id: "BpkBubble",
  imports: [
    "import BpkBubble from '@skyscanner-internal/backpack-web/bpk-component-bubble';",
  ],
