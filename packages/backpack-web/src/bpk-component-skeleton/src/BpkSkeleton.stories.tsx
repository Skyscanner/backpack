...
import STYLES from './BpkSkeleton.stories.module.scss';
...
const ImageDefaultSizeWithRoundedStyleExample = () => (
  <BpkSkeleton type={SKELETON_TYPES.image} style={IMAGE_SKELETON_STYLE.rounded} />
);
...
export const ImageSkeleton = {
  render: () => <ImageSkeletonExample />,
};

export const BodyTextSkeleton = {
  render: () => <BodyTextSkeletonExample />,
};

export const CircleSkeleton = {
  render: () => <CircleSkeletonExample />,
};

export const HeadlineSkeleton = {
  render: () => <HeadlineSkeletonExample />,
};

export const CombinedComponent = {
  render: () => <CombinedComponentExample />,
};

export const BackgroundStyleDefault = {
  render: () => <BackgroundStyleDefaultExample />,
};

export const BackgroundStyleOnContrast = {
  render: () => <BackgroundStyleOnContrastExample />,
};
