...
} satisfies Meta<typeof BpkDataTable>;

type Story = StoryObj<typeof BpkDataTable>;

export const Autowidth: Story = { render: () => <AutowidthExample /> };
export const RowsNotHoverableOrClickable: Story = { render: () => <NonClickNonHoverRowsExample /> };

export const FixedWidth: Story = { render: () => <FixedWidthExample /> };
export const DisabledSort: Story = { render: () => <DisabledSortExample /> };
export const CustomRowAndHeaderHeights: Story = { render: () => <CustomRowAndHeaderHeightsExample /> };

export const CustomSorting: Story = { render: () => <CustomSortingExample /> };

export const CustomHeaderData: Story = { render: () => <HeaderRendererExample /> };

export const WithColumnArray: Story = { render: () => <WithColumnArrayExample /> };

export const VisualTest: Story = { render: () => <AutowidthExample /> };
