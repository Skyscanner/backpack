...
export const BpkFlareBarDefault = {
  render: () => <FlareBarExample />,
};

export const BpkContentBubbleFullWidthWithBackgroundImage = {
  render: () => <ContentBubbleFullWithImageExample />,
};

export const BpkContentBubbleFullWidthWithContent = {
  render: () => <ContentBubbleFullWithContentExample />,
};

export const BpkContentBubbleRounded = {
  render: () => <ContentBubbleRoundedExample />,
};

export const BpkContentBubbleStandalone = {
  render: () => <ContentBubbleStandaloneExample />,
};

export const BpkContentBubbleFixedHeight = {
  render: () => <ContentBubbleFixedHeightExample />,
};
