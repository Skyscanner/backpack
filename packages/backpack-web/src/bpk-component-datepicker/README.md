...
import BpkDatepicker, { CALENDAR_SELECTION_TYPE } from '@skyscanner-internal/backpack-web/bpk-component-datepicker';
...
```js
import { Component } from 'react';
import BpkDatepicker from '@skyscanner-internal/backpack-web/bpk-component-datepicker';
import {
  BpkCalendarNav,
