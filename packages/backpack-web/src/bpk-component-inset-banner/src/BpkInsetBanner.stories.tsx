...
export const DefaultWithTitleAndSubheadline = {
  render: () => <DefaultExampleTitleAndSubheadline />,
};

export const WithLogoAndCtaTextLight = {
  render: () => <WithLogoAndCtaTextExampleLight />,
};

export const WithBodyTextLight = {
  render: () => <WithBodyTextExampleLight />,
};

export const WithBodyTextAndLinkDark = {
  render: () => <WithBodyTextAndLinkExampleDark />,
};
...
export const WithCtaTextAndPopoverLight = {
  render: () => <WithCtaTextAndPopoverExampleLight />,
};
