...
/**
 * Dir example – demonstrates the `dir` prop for controlling text direction.
 *
...
const DirExample = () => (
  <LayoutWrapper>
    <BpkBox padding={BpkSpacing.SM} marginBottom={BpkSpacing.MD}>
      <BpkText textStyle={TEXT_STYLES.label2}>dir=&quot;ltr&quot; — left-to-right text</BpkText>
    ...
    <BpkBox padding={BpkSpacing.SM}>
      <BpkText textStyle={TEXT_STYLES.label2}>dir=&quot;rtl&quot; — right-to-left text</BpkText>
