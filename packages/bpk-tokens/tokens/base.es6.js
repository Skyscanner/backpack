...
export const bannerAlertChildrenPaddingX = "1rem";
export const bannerAlertChildrenPaddingY = ".5rem";
...
export const bannerAlertHeaderPaddingX = "1rem";
export const bannerAlertHeaderPaddingY = ".5rem";
...
export const borderRadiusPillLg = "50%";
...
export const buttonIconBorderRadius = "50%";
export const buttonIconBorderRadiusLg = "50%";
export const buttonLargeFontSize = "1.5rem";
export const buttonLargeLineHeight = "2rem";
export const buttonLargePaddingX = "1.5rem";
export const buttonLargePaddingXIconOnly = ".25rem";
export const buttonLargePaddingY = ".5rem";
...
export const buttonPaddingX = "1rem";
export const buttonPaddingXIconOnly = ".65rem";
export const buttonPaddingY = ".5rem";
...
export const calendarDaySize = "2rem";
...
export const calendarPadding = "1rem";
...
export const flareCornerRadius = "50%";
export const flareHeightDesktop = "2rem";
export const flareHeightMobile = "1.5rem";
...
export const formValidationArrowSize = ".5rem";
export const formValidationColor = "rgb(209, 67, 91)";
export const gridColumns = "12";
export const gridContainerMobilePadding = "1rem";
export const gridContainerPadding = "2rem";
export const gridGutter = "2rem";
...
export const headingContentMarginTop = "2.5rem";
export const headingMarginBottom = "1rem";
...
export const inputLargeHeight = "3.5rem + .5rem";
...
export const panelPadding = "1rem";
export const primaryGradient = "#0770e3";
export const pMarginBottom = "1rem";
export const pMarginTop = "0";
export const radioCheckedCircleColor = "rgb(7, 112, 227)";
export const ratingBaseHeight = "1rem * 4";
export const ratingBaseWidth = "1rem * 4";
export const ratingLgHeight = "2.5rem * 2";
export const ratingLgWidth = "2.5rem * 2";
export const ratingSmHeight = "1rem * 3";
export const ratingSmWidth = "1rem * 3";
...
export const selectHeight = "3rem";
export const selectLargeHeight = "3.5rem + .5rem";
export const selectPaddingBottom = ".5rem";
export const selectPaddingLeft = "1rem";
export const selectPaddingRight = "2.5rem";
export const selectPaddingTop = ".5rem";
export const spacingBase = "2rem";
export const spacingLg = "2.5rem";
export const spacingMd = "1.5rem";
export const spacingNone = "0";
export const spacingSm = "1rem";
export const spacingXl = "3rem";
export const spacingXs = ".5rem";
export const spacingXxl = "3.5rem";
export const spacingXxs = ".25rem";
export const stateSelectedBackgroundColor = "rgb(8, 78, 178)";
export const textareaMinHeight = "3.5rem * 2";
