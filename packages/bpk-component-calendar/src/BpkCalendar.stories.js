...
import {
  ...
  weekDaysJapanese,
  weekDays,
} from './BpkCalendar.stories-test-utils';
import { BpkCalendarContainerMock } from './BpkCalendar.stories-utils';
import BpkCalendarDateComponent from './BpkCalendarDate';
import BpkCalendarGridComponent from './BpkCalendarGrid';
import BpkCalendarGridHeaderComponent from './BpkCalendarGridHeader';
import BpkCalendarNavComponent from './BpkCalendarNav';
...
export const CalendarNav = { render: () => <CalendarNavExample /> };

export const CalendarGridHeader = { render: () => <CalendarGridHeaderExample /> };

export const CalendarGrid = { render: () => <CalendarGridExample /> };

export const BpkCalendarGridHeaderBpkCalendarGrid = { render: () => <CalendarGridAndHeaderExample /> };

export const CalendarDefault = { render: () => <DefaultExample /> };

export const CalendarMinDateInThePastFocusingToday = { render: () => <MinDateInThePastExample /> };

export const CalendarWeekStartsOnASunday = { render: () => <WeekStartsOnSundayExample /> };

export const CalendarHonestWeekend = { render: () => <HonestWeekendExample /> };

export const CalendarWeekDayKeyIsNameNarrow = { render: () => <WeekdayKeyIsNameNarrowExample /> };

export const CalendarArAeLocale = { render: () => <ArabicExample /> };

export const CalendarJaJpLocale = { render: () => <JapaneseExample /> };

export const CalendarSpecifyMinMaxDate = { render: () => <MinAndMaxDateExample /> };

export const CalendarDontMarkToday = { render: () => <MarkTodayFalseExample /> };

export const CalendarDontMarkOutsideDays = { render: () => <MarkOutsideDaysFalseExample /> };
...
export const VisualTestWithZoom = {
  render: () => <FocusedDateInThePastExample />,
  args: {
    zoomEnabled: true,
  },
};

export const VisualTestRange = { render: () => <RangeDateCalendarExample /> };

export const VisualTestRangeWithZoom = {
  render: () => <RangeDateCalendarExample />,
  args: {
    zoomEnabled: true,
  },
};
