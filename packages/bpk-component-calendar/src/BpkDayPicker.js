...
import DayPickerNavigation from 'react-dates/lib/components/DayPickerNavigation';
import getTransformStyles from 'react-dates/lib/utils/getTransformStyles';
import OrientationShape from 'react-dates/lib/shapes/OrientationShape';

import { HORIZONTAL_ORIENTATION, VERTICAL_ORIENTATION } from 'react-dates/constants';

const CALENDAR_MONTH_WIDTH = 312;
const DAY_PICKER_PADDING = 0;
const MONTH_PADDING = 12;
...
export default class DayPicker extends React.Component {
  ...
  getMonthHeight(el) {
    ...
    return (
      ...
      this.calculateDimension(grid, 'height') + 6 // TODO: 6 because table spacing stuff
    );
  }
