...
import STYLES from './BpkDrawer.stories.module.scss';
...
export const Overflowing = { render: () => <OverflowingExamples /> };
export const CloseButtonText = { render: () => <CloseButtonTextExample /> };
export const WithVisuallyHiddenTitle = { render: () => <WithVisuallyHiddenTitleExample /> };
export const WithFullHeightContent = { render: () => <WithFullHeightContentExample /> };
export const WithNonPaddedContent = { render: () => <WithNonPaddedContentExample /> };
