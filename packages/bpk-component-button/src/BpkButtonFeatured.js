...
import STYLES from './BpkButtonFeatured.scss';
...
const BpkButtonFeatured = (props: Props) => {
  const {
    children,
    href,
    className,
  ...
  const classNames = [
    ...
    getClassName('bpk-button--featured'),
  ];
...
BpkButtonFeatured.propTypes = { ...propTypes };
BpkButtonFeatured.defaultProps = { ...defaultProps };
