...
describe('BpkButtonPrimary', () => {
  it('should render correctly', () => {
    const tree = renderer
      .create(<BpkButtonPrimary>My button</BpkButtonPrimary>)
      .toJSON();
  ...
  it('should render correctly with a "href" attribute', () => {
    const tree = renderer
      .create(<BpkButtonPrimary href="#">My button</BpkButtonPrimary>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with a "disabled" attribute', () => {
    const tree = renderer
      .create(<BpkButtonPrimary disabled>My button</BpkButtonPrimary>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with a "large" attribute', () => {
    const tree = renderer
      .create(<BpkButtonPrimary large>My button</BpkButtonPrimary>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with an "iconOnly" attribute', () => {
    const tree = renderer
      .create(<BpkButtonPrimary iconOnly>My button</BpkButtonPrimary>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should add only bpk specific classes if className prop is set to empty string', () => {
    const tree = renderer
      .create(
        <BpkButtonPrimary large className="">
          My button
        </BpkButtonPrimary>,
      )
      .toJSON();
  ...
  it('should render correctly with "rel" attribute', () => {
    const tree = renderer
      .create(
        <BpkButtonPrimary href="#" rel="rel-attr">
          My button
        </BpkButtonPrimary>,
      )
      .toJSON();
  ...
  it('should render correctly with "blank" and "rel" attributes', () => {
    const tree = renderer
      .create(
        <BpkButtonPrimary href="#" blank rel="rel-overwrite">
          My button
        </BpkButtonPrimary>,
      )
      .toJSON();
  ...
  it('should render correctly with "disabled" and "href" attributes', () => {
    const tree = renderer
      .create(
        <BpkButtonPrimary href="#" disabled>
          My button
        </BpkButtonPrimary>,
      )
      .toJSON();
