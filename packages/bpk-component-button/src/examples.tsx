...
import LargeLongArrowRightIcon from '@backpack/bpk-component-icon/lg/long-arrow-right';
import SmallLongArrowRightIcon from '@backpack/bpk-component-icon/sm/long-arrow-right';
