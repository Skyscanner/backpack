...
describe('chartDataProp', () => {
  it('should fail if data is not an array', () => {
    const result = chartDataProp(
      // @ts-expect-error TS(2345): Argument of type '{ data: {}; xScaleDataKey: strin... Remove this comment to see the full error message
  ...
  it('should fail if on object is missing a scale key', () => {
    const result = chartDataProp(
      // @ts-expect-error TS(2345): Argument of type '{ data: { day: string; value: nu... Remove this comment to see the full error message
  ...
  it('should return null for valid data', () => {
    const result = chartDataProp(
      // @ts-expect-error TS(2345): Argument of type '{ data: { day: string; price: nu... Remove this comment to see the full error message
