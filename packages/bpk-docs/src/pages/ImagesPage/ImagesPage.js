    ...
    examples: [
      <BpkImage
        ...
        srcSet={`${image1}?resize=280px:280px&quality=100 280w,
          ...
          ${image1}?resize=460px:460px&quality=100 460w,
    ...
    examples: [
      <FadingImage
        ...
        srcSet={`${image3}?resize=280px:280px&quality=100 280w,
          ...
          ${image3}?resize=460px:460px&quality=100 460w,
    ...
    examples: [
      <LazyLoadedImage
        ...
        srcSet={`${image4}?resize=280px:280px&quality=100 280w,
          ...
          ${image4}?resize=460px:460px&quality=100 460w,
    ...
    examples: [
      <FadingLazyLoadedImage
        ...
        srcSet={`${image5}?resize=280px:280px&quality=100 280w,
          ...
          ${image5}?resize=460px:460px&quality=100 460w,
