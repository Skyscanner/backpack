...
const IconsPage = () => (
  <section>
    ...
    <BpkParagraph>
      Each icon is  simple, modern, and has a friendly style. We use icons to convey information quickly and accurately,
      and therefore they should not be overly decorative or detailed. This also helps to ensure readability and clarity
      at small sizes.
    </BpkParagraph>
    <BpkParagraph>
