...
export const AUTOSUGGEST = '/components/autosuggest';
export const POPOVER = '/components/popover';
...
export const TOUCHABLE_OVERLAY = '/components/touchable-overlay';
export const TOUCHABLE_NATIVE_FEEDBACK =
