...
describe('BpkHorizontalNav', () => {
  it('should render correctly', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2740): Type '{ children: string; }' is missing the follow... Remove this comment to see the full error message
  ...
  it('should render correctly with custom "className" prop', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2740): Type '{ children: string; className: string; }' is... Remove this comment to see the full error message
  ...
  it('should render correctly with custom "leadingScrollIndicatorClassName" prop', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2740): Type '{ children: string; leadingScrollIndicatorCl... Remove this comment to see the full error message
  ...
  it('should render correctly with custom "trailingScrollIndicatorClassName" prop', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2740): Type '{ children: string; trailingScrollIndicatorC... Remove this comment to see the full error message
  ...
  it('should render correctly with "showUnderline" set to false', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2740): Type '{ children: string; showUnderline: false; }'... Remove this comment to see the full error message
  ...
  it('should render correctly with arbitrary props', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2740): Type '{ children: string; "data-arbitrary-1": stri... Remove this comment to see the full error message
      <BpkHorizontalNav
  ...
  it('should render correctly with "ariaLabel" prop', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2740): Type '{ children: string; ariaLabel: string; }' is... Remove this comment to see the full error message
