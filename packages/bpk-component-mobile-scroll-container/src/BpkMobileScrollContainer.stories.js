...
import STYLES from './BpkMobileScrollContainer.stories.module.scss';
...
export const WithVisibleScrollbar = {
  render: () => <WithVisibleScrollbarExample />,
};

export const SettingLeadingIndicatorClassNameAndTrailingIndicatorClassName = {
  render: () => <SettingLeadingAndTrailingIndicatorClassNameExample />,
};
