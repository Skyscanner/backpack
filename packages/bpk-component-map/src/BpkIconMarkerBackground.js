...
const BpkIconMarkerBackground = (props: Props) => {
  ...
  const classNames = getClassName(
    STYLES["bpk-icon-marker-background"],
    interactive && STYLES["bpk-icon-marker-background--interactive"],
    disabled && STYLES["bpk-icon-marker-background--disabled"],
    selected && STYLES["bpk-icon-marker-background--selected"],
  );
