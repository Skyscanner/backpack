...
import BpkButton, {
  BUTTON_TYPES,
} from '@backpack/bpk-component-button';
import { withButtonAlignment } from '@backpack/bpk-component-icon';
import CloseIcon from '@backpack/bpk-component-icon/sm/close';
import EditIcon from '@backpack/bpk-component-icon/sm/edit';
import HeartIcon from '@backpack/bpk-component-icon/sm/heart';
import ShareIcon from '@backpack/bpk-component-icon/sm/share';
import TrashIcon from '@backpack/bpk-component-icon/sm/trash';
