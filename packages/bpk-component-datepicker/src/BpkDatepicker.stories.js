...
import STYLES from './BpkDatepicker.stories.module.scss';
...
export const Range = { render: () => <RangeExample /> };
export const OpenOnFirstRender = { render: () => <OpenOnFirstRenderExample /> };
export const MinDateInThePast = { render: () => <MinDateInPastExample /> };
export const WithoutDateSet = { render: () => <WithoutDateSetExample /> };
export const PassingThroughPropsToUnderlyingInput = { render: () => <PassingPropsExample /> };
export const DepartReturn = { render: () => <DepartReturnExample /> };
export const CustonCalendarComponent = { render: () => <CustomComponentExample /> };
export const Invalid = { render: () => <InvalidExample /> };
export const RangeWithMultipleInputs = { render: () => <MultipleRangeInputExample /> };
export const VisualTest = { render: () => <DefaultVisualExample /> };
export const VisualTestRange = { render: () => <VisualRangeExample /> };
export const VisualTestWithZoom = { render: () => <DefaultVisualExample />, args: { zoomEnabled: true } };
export const VisualTestRangeWithZoom = { render: () => <VisualRangeExample />, args: { zoomEnabled: true } };
