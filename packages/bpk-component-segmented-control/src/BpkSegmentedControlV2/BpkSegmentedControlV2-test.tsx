...
// ─── US1: Basic composable segment group ──────────────────────────────────────
...
describe('BpkSegmentedControlV2 — US1: Basic composable segment group', () => {
  ...
  it('applies aria-label from label prop', () => {
    render(<ThreeItemControl />);
    expect(screen.getByRole('radiogroup')).toHaveAttribute('aria-label', 'Sort by');
  });
  ...
  it('individual item disabled: only that item is non-interactive', () => {
    const onChange = jest.fn();
    render(
      <BpkSegmentedControlV2.Root label="Cabin class" value="economy" onChange={onChange}>
...
describe('BpkSegmentedControlV2 — US2: Manual activation mode', () => {
  ...
  it('manual mode: ArrowRight moves DOM focus but does NOT call onChange', async () => {
    ...
    const user = userEvent.setup();
    render(
      <BpkSegmentedControlV2.Root label="Sort" value="price" onChange={onChange} activationMode="manual">
        <BpkSegmentedControlV2.Item value="price">Price</BpkSegmentedControlV2.Item>
        <BpkSegmentedControlV2.Item value="rating">Rating</BpkSegmentedControlV2.Item>
        <BpkSegmentedControlV2.Item value="duration">Duration</BpkSegmentedControlV2.Item>
      </BpkSegmentedControlV2.Root>,
...
describe('BpkSegmentedControlV2 — US4: Style variants', () => {
  ...
  it('snapshot: canvas-contrast', () => {
    const { container } = render(
      <BpkSegmentedControlV2.Root label="Snapshot" type={SEGMENT_TYPES_V2.CanvasContrast} defaultValue="price">
        <BpkSegmentedControlV2.Item value="price">Price</BpkSegmentedControlV2.Item>
        <BpkSegmentedControlV2.Item value="rating">Rating</BpkSegmentedControlV2.Item>
      </BpkSegmentedControlV2.Root>,
    );
  ...
  it('snapshot: surface-default', () => {
    const { container } = render(
      <BpkSegmentedControlV2.Root label="Snapshot" type={SEGMENT_TYPES_V2.SurfaceDefault} defaultValue="price">
        <BpkSegmentedControlV2.Item value="price">Price</BpkSegmentedControlV2.Item>
        <BpkSegmentedControlV2.Item value="rating">Rating</BpkSegmentedControlV2.Item>
      </BpkSegmentedControlV2.Root>,
    );
  ...
  it('snapshot: surface-contrast', () => {
    const { container } = render(
      <BpkSegmentedControlV2.Root label="Snapshot" type={SEGMENT_TYPES_V2.SurfaceContrast} defaultValue="price">
        <BpkSegmentedControlV2.Item value="price">Price</BpkSegmentedControlV2.Item>
        <BpkSegmentedControlV2.Item value="rating">Rating</BpkSegmentedControlV2.Item>
      </BpkSegmentedControlV2.Root>,
    );
  ...
  it('snapshot: root disabled', () => {
    render(
      <BpkSegmentedControlV2.Root label="Snapshot" defaultValue="price" disabled>
        <BpkSegmentedControlV2.Item value="price">Price</BpkSegmentedControlV2.Item>
        <BpkSegmentedControlV2.Item value="rating">Rating</BpkSegmentedControlV2.Item>
      </BpkSegmentedControlV2.Root>,
    );
...
describe('BpkSegmentedControlV2 — US5: Composable custom content', () => {
  ...
  it('item with accessibilityLabel has aria-label on ItemControl', () => {
    ...
    const control = document.querySelector('[class*="item-control"]') as HTMLElement;
  ...
  it('item without accessibilityLabel does not have aria-label on ItemControl', () => {
    render(
      <BpkSegmentedControlV2.Root label="Layout" defaultValue="text">
        <BpkSegmentedControlV2.Item value="text">Text Only</BpkSegmentedControlV2.Item>
      </BpkSegmentedControlV2.Root>,
    );
    const control = document.querySelector('[class*="item-control"]') as HTMLElement;
