...
import BpkNavigationBarIconButton from './BpkNavigationBarIconButton';

import STYLES from './BpkNavigationBar.stories.module.scss';

const getClassNames = cssModules(STYLES);
const ArrowIconWithRtl = withRtlSupport(ArrowIcon);

// Inlined from AirlineLogo.js
const AirlineLogo = () => (
  <span>
    <svg
      width="110px"
...
export const LeadingIconOnly = {
  render: () => <LeadingIconOnlyExample />,
};

export const TrailingIconOnly = {
  render: () => <TrailingIconOnlyExample />,
};
...
export const WithLinksOnDark = {
  render: () => <WithLinksOnDarkExample />,
};
