...
describe('BpkLoadingButton', () => {
  it('should render correctly', () => {
    const tree = renderer
      .create(<BpkLoadingButton>My button</BpkLoadingButton>)
      .toJSON();
  ...
  it('should render correctly with a "href" attribute', () => {
    const tree = renderer
      .create(<BpkLoadingButton href="#">My button</BpkLoadingButton>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with a "secondary" attribute', () => {
    const tree = renderer
      .create(<BpkLoadingButton secondary>My button</BpkLoadingButton>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with a "destructive" attribute', () => {
    const tree = renderer
      .create(<BpkLoadingButton destructive>My button</BpkLoadingButton>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with a "link" attribute', () => {
    const tree = renderer
      .create(<BpkLoadingButton link>My button</BpkLoadingButton>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with a "loading" attribute', () => {
    const tree = renderer
      .create(<BpkLoadingButton loading>My button</BpkLoadingButton>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('should render correctly with a "large" attribute', () => {
    const tree = renderer
      .create(<BpkLoadingButton large>My button</BpkLoadingButton>)
      .toJSON();
    expect(tree).toMatchSnapshot();
  });
