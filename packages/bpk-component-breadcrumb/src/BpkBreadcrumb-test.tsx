...
describe('BpkBreadcrumb', () => {
  ...
  it('should render correctly with a custom class name', () => {
    const { asFragment } = render(
      // @ts-expect-error TS(2322): Type '{ children: Element; label: string; classNam... Remove this comment to see the full error message
  ...
  it('should render correctly with arbitrary props', () => {
    const { asFragment } = render(
      <BpkBreadcrumb
        ...
        // @ts-expect-error TS(2322): Type '{ children: Element; label: string; testid: ... Remove this comment to see the full error message
