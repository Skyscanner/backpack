...
import STYLES from './BpkBottomSheet.stories.module.scss';
...
BottomSheetContainer.propTypes = {
  ...
  id: PropTypes.string,
  isComponentOpen: PropTypes.bool,
};
...
const LongHeaderWithCustomTitleExample = () => (
  <BottomSheetContainer
    title={
      <BpkText tagName="h3" textStyle={TEXT_STYLES.label1}>
        Bottom Sheet custom title which is long
      </BpkText>
    }
    closeLabel="Close Bottom Sheet"
  >
...
export const BackdropClickClose = { render: () => <BackdropClickCloseExample /> };
export const EscapeClose = { render: () => <EscapeCloseExample /> };
export const Overflowing = { render: () => <OverflowingExample /> };
export const LongHeaderText = { render: () => <LongHeaderTextExample /> };
export const LongHeaderTextWithActionButton = {
  render: () => <LongHeaderTextWithActionButtonExample />,
};
export const LongHeaderWithCustomTitle = {
  render: () => <LongHeaderWithCustomTitleExample />,
};
export const LongHeaderWithCustomTitleAndAction = {
  render: () => <LongHeaderWithCustomTitleAndActionExample />,
};
export const NoHeader = { render: () => <NoHeaderExample /> };
export const NoHeaderWithActionButton = {
  render: () => <NoHeaderWithActionButtonExample />,
};
export const ActionButton = { render: () => <ActionButtonExample /> };
export const Wide = { render: () => <WideExample /> };
export const Nested = { render: () => <NestedExample /> };
export const MultipleBottomSheets = {
  render: () => <MultipleBottomSheetsExample />,
};
export const NoPadding = { render: () => <NoPaddingExample /> };
export const BasePadding = { render: () => <BasePaddingExample /> };
