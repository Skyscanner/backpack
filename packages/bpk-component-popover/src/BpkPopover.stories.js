...
import STYLES from './BpkPopover.stories.module.scss';
...
const Spacer = ({ children }) => (
  <div className={getClassName('bpk-popover-spacer')}>{children}</div>
);
...
export const WithCustomRenderTarget = { render: () => <WithCustomRenderTargetExample /> };
export const Hover = { render: () => <HoverExample /> };
export const WithoutArrow = { render: () => <WithoutArrowExample /> };
export const WithLabelAsTitle = { render: () => <WithLabelAsTitleExample /> };
export const WithNoCloseButtonIcon = { render: () => <WithNoCloseButtonIconExample /> };
export const OnTheSide = { render: () => <OnTheSideExample /> };
export const TriggeredByInput = { render: () => <InputTriggerExample /> };
