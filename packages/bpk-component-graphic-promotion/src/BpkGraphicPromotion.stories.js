...
export const DefaultNoBackgroundImage = {
  render: () => <NoStyleExample />,
};

export const DefaultWithBackgroundImage = {
  render: () => <DefaultExample />,
};

export const CenterAligned = {
  render: () => <CenterAlignedExample />,
};

export const RightAligned = {
  render: () => <RightAlignedExample />,
};

export const InvertedPortraitMode = {
  render: () => <InvertedPortraitExample />,
};

export const Minimalistic = {
  render: () => <MinimalisticExample />,
};

export const MinimalisticRightAligned = {
  render: () => <MinimalisticRightAlignedExample />,
};

export const NonSponsored = {
  render: () => <NonSponsoredExample />,
};

export const NonSponsoredCenterAligned = {
  render: () => <NonSponsoredCenterAlignedExample />,
};

export const NonSponsoredRightAligned = {
  render: () => <NonSponsoredRightAlignedExample />,
};

export const LinkWrapper = {
  render: () => <LinkWrapperExample />,
};
