 ...
 */
import type { BpkNavigationTabGroupProps } from '@backpack/bpk-component-navigation-tab-group';

import STYLES from './examples.module.scss';

import { withRtlSupport } from '@backpack/bpk-component-icon';
import Car from '@backpack/bpk-component-icon/sm/cars';
import Explore from '@backpack/bpk-component-icon/sm/explore';
import Flight from '@backpack/bpk-component-icon/sm/flight';
import Hotel from '@backpack/bpk-component-icon/sm/hotels';
import BpkNavigationTabGroup, { NAVIGATION_TAB_GROUP_TYPES } from '@backpack/bpk-component-navigation-tab-group';
