...
// A large loading spinner used to indicate an ongoing operation.
// It supports dark, light, and on-dark colour variants, and can optionally align itself to a large button for inline use.
