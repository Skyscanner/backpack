...
the implementation. Each task should be executable without re-reading spec or plan.
...
❌ EXCLUDE from tasks.md (belongs in plan.md):
- Implementation patterns and code examples
- Architecture decisions and trade-offs
- Complete TypeScript interface definitions
- Sass/CSS pattern explanations
