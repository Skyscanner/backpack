      ...
      <ul>
        ...
        <li>
          For improved cross-browser rendering, we use <a href='http://necolas.github.io/normalize.css/'
            target='__blank'>normalize.css</a> to correct small
        ...
        <li>
          Utility classes based on the utils mixins above, including: `.hidden`, `.visuallyhidden`,
          `.visuallyhidden.focusable`, `.invisible` and `.clearfix`
        </li>
        <li>That's it!</li>
      </ul>
    </section>
