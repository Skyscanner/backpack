---
name: nx-migrate-component
description: Migrate a Backpack component to NX monorepo structure following Skyscanner production standards. Use when migrating components from legacy build to NX, setting up new components, or standardizing component configuration.
...
4. Updating import paths across the codebase
